...
namespace WindowsFormsDemo
{
    public partial class WindowsFormsDemoForm : Form
    {
        ...
        private void cmb_mesesnov_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmb_anos.Text != "" && x.ToString ()!= "0")
            {
                day1 = Convert.ToDateTime(cmb_anos.Text + "-" + x.ToString() + "-1");
                day2 = day1.AddMonths(1).AddDays(-1);
            }
            ...
            if (lbl_idempnov.Text == "")
            {
                ...
                {
                    dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad' from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where desde between '" + day1.ToString("yyyy-MM-dd") + "' and '" + day2.ToString("yyyy-MM-dd") + "' or (hasta between '" + day1.ToString("yyyy-MM-dd") + "' and '" + day2.ToString("yyyy-MM-dd") + "')  or ('" + day1.ToString("yyyy-MM-dd") + "' between desde and hasta) or ('" + day2.ToString("yyyy-MM-dd") + "' between desde and hasta) order by desde asc");
                }
            }
            else
            {
                ...
                {
                    dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad' from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + day1.ToString("yyyy-MM-dd") + "' and '" + day2.ToString("yyyy-MM-dd") + "' or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + day1.ToString("yyyy-MM-dd") + "' and '" + day2.ToString("yyyy-MM-dd") + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + day1.ToString("yyyy-MM-dd") + "' between desde and hasta) or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + day2.ToString("yyyy-MM-dd") + "' between desde and hasta) order by desde asc");
                }
            }
            dataGridView3.Columns[0].Visible = false;
                ...
                if (desde <= hasta)
                {
                    if (lbl_idempnov.Text == "")
                    {
                        ...
                        else
                        {
                            ...
                            {
                                dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad', datediff(hasta,desde) + 1 as Diferencia from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "' or ('" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "') or (desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "') or (hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "') order by desde asc");
                                DataTable dt = oacceso.leerDatos("select sum(datediff(hasta,desde)+1) as dias from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "' or ('" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "') or (desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "') or (hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "') order by desde asc");
                                string dias = "";
                                foreach (DataRow dr in dt.Rows)
                                {
                            ...
                            {
                                dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad', datediff(hasta,desde) + 1 as Diferencia from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and t.detalle = '" + cmb_tiponov1.Text + "' or ('" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and t.detalle = '" + cmb_tiponov1.Text + "') or (desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and t.detalle = '" + cmb_tiponov1.Text + "') or (hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and t.detalle = '" + cmb_tiponov1.Text + "') order by desde asc");
                                DataTable dt = oacceso.leerDatos("select sum(datediff(hasta,desde)+1) as dias from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and t.detalle = '" + cmb_tiponov1.Text + "' or ('" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and t.detalle = '" + cmb_tiponov1.Text + "') or (desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and t.detalle = '" + cmb_tiponov1.Text + "') or (hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and t.detalle = '" + cmb_tiponov1.Text + "') order by desde asc");
                                string dias = "";
                                foreach (DataRow dr in dt.Rows)
                                {
                            ...
                            {
                                dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad', datediff(hasta,desde) + 1 as Diferencia from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta or ('" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta) or (desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "') or (hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "') order by desde asc");
                                DataTable dt = oacceso.leerDatos("select sum(datediff(hasta,desde)+1) as dias from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta or ('" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta) or (desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "') or (hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "') order by desde asc");
                                string dias = "";
                                foreach (DataRow dr in dt.Rows)
                                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (checkBox2.Checked && checkBox3.Checked)
                            {
                                dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad', datediff(hasta,desde) + 1 as Diferencia from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "' and t.detalle = '" + cmb_tiponov1.Text + "' or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "' and t.detalle = '" + cmb_tiponov1.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "' and t.detalle = '" + cmb_tiponov1.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "' and t.detalle = '" + cmb_tiponov1.Text + "') order by desde asc");
                                DataTable dt = oacceso.leerDatos("select sum(datediff(hasta,desde)+1) as dias from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "' and t.detalle = '" + cmb_tiponov1.Text + "' or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "' and t.detalle = '" + cmb_tiponov1.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "' and t.detalle = '" + cmb_tiponov1.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "' and t.detalle = '" + cmb_tiponov1.Text + "') order by desde asc");
                                string dias = "";
                                foreach (DataRow dr in dt.Rows)
                                {
                            ...
                            {
                                dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad', datediff(hasta,desde) + 1 as Diferencia from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "' or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "') order by desde asc");
                                DataTable dt = oacceso.leerDatos("select sum(datediff(hasta,desde)+1) as dias from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "' or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and tn.detalle = '" + cmb_tiponov.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and tn.detalle = '" + cmb_tiponov.Text + "') order by desde asc");
                                string dias = "";
                                foreach (DataRow dr in dt.Rows)
                                {
                            ...
                            {
                                dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad', datediff(hasta,desde) + 1 as Diferencia from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and t.detalle = '" + cmb_tiponov1.Text + "' or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and t.detalle = '" + cmb_tiponov1.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and t.detalle = '" + cmb_tiponov1.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and t.detalle = '" + cmb_tiponov1.Text + "') order by desde asc");
                                DataTable dt = oacceso.leerDatos("select sum(datediff(hasta,desde)+1) as dias from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta and t.detalle = '" + cmb_tiponov1.Text + "' or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta and t.detalle = '" + cmb_tiponov1.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and t.detalle = '" + cmb_tiponov1.Text + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "' and t.detalle = '" + cmb_tiponov1.Text + "') order by desde asc");
                                string dias = "";
                                foreach (DataRow dr in dt.Rows)
                                {
                            ...
                            {
                                dataGridView3.DataSource = oacceso.leerDatos("select n.idnovedades as idnovedades, case when n.idempleados = 0 then 'Afecta todos' else e.nombre END AS Empleado, desde as Desde, hasta as Hasta, n.detalle as Novedad, concat(tn.detalle, ' ', t.detalle) as 'Tipo de Novedad', datediff(hasta,desde) + 1 as Diferencia from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta) or (n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "') order by desde asc");
                                DataTable dt = oacceso.leerDatos("select sum(datediff(hasta,desde)+1) as dias from novedades n left join empleados e on n.idempleados = e.idempleados inner join tiposdenovedades t on n.idtiposdenovedades = t.idtiposdenovedades inner join tipodenovedad tn on tn.idtiponovedad = t.idtipodenovedad where n.idempleados = '" + lbl_idempnov.Text + "' and '" + desde.ToString("yyyy-MM-dd") + "' between desde and hasta or (n.idempleados = '" + lbl_idempnov.Text + "' and '" + hasta.ToString("yyyy-MM-dd") + "' between desde and hasta) or (n.idempleados = '" + lbl_idempnov.Text + "' and desde between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "') or (n.idempleados = '" + lbl_idempnov.Text + "' and hasta between '" + desde.ToString("yyyy-MM-dd") + "' and '" + hasta.ToString("yyyy-MM-dd") + "') order by desde asc");
                                string dias = "";
                                foreach (DataRow dr in dt.Rows)
                                {
